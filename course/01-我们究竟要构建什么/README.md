...
- `00:00–01:03`（M001–M002）：观察 ChatGPT 从左到右输出；同一提示可得到不同结果。
- `01:38–03:52`（M004–M007）：语言模型、Transformer 与课程范围。
- `03:52–05:21`（M008–M009）：Tiny Shakespeare 和字符级生成预览。
- `05:21–07:29`（M010–M011）：nanoGPT 与“从空文件搭建”的课程路线。

![视频中的生成预览](../../01-课程介绍与数据准备/assets/crops/00-05-15-generated-preview.png)

这张画面证明视频展示的是“根据前文继续写”的生成效果，不证明模型理解了人物或剧情。

## 5. 跟着完成最小代码

本章用一个手工函数模拟“每次追加一个字符”的外形：

...
- `47:03–50:28`（M062–M065）：行乘列、全一矩阵、下三角和归一化。
- `50:28–54:48`（M066–M070）：具体数字、`T×T @ B×T×C`、`allclose` 与 batch 隔离。
- `54:48–56:58`（M071–M073）：零分数、`-inf` mask 和 softmax。
- `56:58–58:17`（M074–M076）：权重将变成数据相关，过渡到 Attention。

![下三角矩阵代码](../../05-Self-Attention/assets/crops/00-47-30-tril-code.png)
